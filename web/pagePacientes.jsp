                ...
                <div class="container-fluid" style="width: 800px">
                    <div class='row'>
                        <div class="col-lg-12">
                            ...
                            <form name="regPaciente" action="reg_paciente" method='get' onsubmit="return validarInformacion()" id="form">
                            ...
                            <form method="post" action="usuario-paciente" onsubmit="return validarInformacion()">
                                <button type="submit"  class="btn btn-save" name="id" value="${id}" class="btn-link">Ver Histórico  <span class="glyphicon glyphicon-list-alt"></span></button>
                            </form>
                            ...
                            <form method="get" action="/quercus-4.0.39/familiograma/index.html" onsubmit="return validarInformacion()">
                                <button type="submit"  class="btn btn-save" name="idPaciente" value="${id_paciente}" class="btn-link">Familiograma  <span class="glyphicon glyphicon-list-alt"></span></button>
                            </form>
